...
const CartMScreen = () => {
  ...
  return (
       <Box sx={{height:'70vh',width:'90%', backgroundColor:'#fff',borderRadius:'20px',padding:'30px',minWidth:'650px',overflow:'hidden', display:'flex',flexDirection:'column'}} >
        <Box sx={{display:'flex',alignItems:'end', justifyContent:'space-between'}}>
           {/* id there is any warnong message, display here */}
           {
            warningMessage && 
             <div style={{zIndex:2000, position:'absolute', backgroundColor:'red',
              top:'200px',right:'60px', opacity:'0.8', color:'black', borderRadius:'5px',
        ...
        <Box  sx={{width:'100%',overflowX:'scroll',borderRadius:'10px'}}>
           ...
           
          {
            cart?.map((product:any)=>{
              return (
                <li key={product._id} style={{listStyle:'none', display:'flex', justifyContent:'space-between', alignItems:'center',width:'100%',marginTop:'7px'}} >
