...
const CartLScreen = () => {
  ...
  return (
       ...
       <Box sx={{height:'70vh',width:'85%', backgroundColor:'#fff',borderRadius:'20px', display:'flex',justifyContent:'space-between',padding:'40px',minWidth:'900px',overflow:'hidden'}} >

        <Box  sx={{display:'flex', justifyContent:'space-between',width:'65%',overflowY:'scroll', overflowX:'hidden'}}>
          <div>
       ...
       <div style={{display:'flex', alignItems:'end', justifyContent:'space-between'}}>
          <h1 style={{marginTop:'15px',color:'black',marginLeft:'-60px',
          ...
          {/* {
           ...
           <Button style={{textAlign:'center',width:'96%',
             height:'50px',marginTop:'10px'}} sx={{color:'#fff',bgcolor:'#332D2D', ":hover": {
              color:'black',
              bgcolor: "#AF5",
            }}}>Checkout</Button>
