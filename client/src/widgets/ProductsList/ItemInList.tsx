...
import {
  ...
  containerMStyle,
  containerSStyle,
} from "../../styles/ProductsListPage/ItemInList";
        ...
        <div style={{ display: "flex" }}>
          ...
          >
            <div style={{ flexDirection: "column" }}>
              ...
              <p style={{ color: "#526D82", marginTop: "10px" }}>
                {item.shortDescription}
              </p>
              <p style={{ color: "#526D82", marginTop: "5px" }}>
            ...
            <div>
              ...
              <p
                style={{ color: "#526D82", marginTop: "5px", fontSize: "14px" }}
              >
                +{randomShippingPrice(3, 14)}$ shipping
              </p>
              <p
                style={{ color: "#526D82", marginTop: "5px", fontSize: "15px" }}
              >
                +{randomSold(100, 4210)} sold
              </p>
            </div>
          </div>
        </div>
...
// useEffect(() => {
//   axios.post('${baseRenderUrl}/cart/addToCart',{product: cart,userId,totalPrice,totalQuantity})
// }, [cart])
...
//   // setTimeout(
//   //   ()=>{
//   //    axios.post('${baseRenderUrl}/cart/addToCart',{product: item})
//   //   },2000)
//   //    if(!warningMessage){
//   //  }else{
...
//   //   axios.post('${baseRenderUrl}/cart/addToCart',{product: finalProduct,userId, totalQuantity})
//   //   .then(res => {
//   //     dispatch(addToCart(item))
//   //   })
//   //   .catch(error=>{
