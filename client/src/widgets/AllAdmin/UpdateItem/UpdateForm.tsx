...
import {  
  validateShortObj, validateProductNameObj,
   ...
   osObj, priceInputProps, validateID } from './ValidateObjects';
       ...
       <Container sx={containerStyle} maxWidth='sm' component="main" >  
           <Box sx={insideContainerStyle}>
             ...
             <Typography sx={{mb:2,position:'relative'}} component="h1" variant="h5">
                ...
                {
                  step <= 4 ? 'Update: Fill Only What Needed- need to check if need this page.' : 'Item Updated Successfully'
                }              
             </Typography>
                  ...
                  )}
                {
                  step == 2 && (
                   ...
                   {step == 3 && (
                    ...
                    {renderButton(step,nextStep,isValid)}
