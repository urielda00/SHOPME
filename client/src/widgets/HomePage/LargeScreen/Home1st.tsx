...
const Home1st = () => {
  return (
    <Box style={containerStyle}>
     ...
     <Link to='/productsList' style={{position:'relative',left:'55%', top:'5%', width:'160px', height:'60px', backgroundColor:'#FC2947'}}><Button variant='contained' size='large' style={{width:'100%',height:'100%',backgroundColor:'#FC2947'}}>Buy Now</Button></Link>
    </Box>
  )
}
