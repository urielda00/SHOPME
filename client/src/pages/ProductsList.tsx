...
// // import { useGetProductsData } from '../services/FetchCustomHooks/useGetProductsData';
...
//   const someNumber=1
//   // const {isLoading, data, isError, error} =useGetProductsData(someNumber)
//   // useEffect(()=>{
  
//   // readProducts(setProducts, pageNumber) 
...
//         </div>
//       </ul>
//       <Button onClick={()=>{setPageNumber(prev => prev + 1)  }}>See More Items</Button>
//      </div>
//   )
// }
