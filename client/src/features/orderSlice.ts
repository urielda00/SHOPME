...
export const orderSlice= createSlice({
  ...
  placeOrder: (state,action)=>{
    isLogged === 'true' ? createOrderAPI (action.payload.isAddress,action.payload.cart,action.payload.userName) : createOrderNoUserAPI(action.payload.isAddress,action.payload.cart)
  }
  },
})
