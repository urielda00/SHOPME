...
export const registerValidation = [
	check('firstName')
		...
		.withMessage('Please enter the name between 2 to 15 characters'),
	...
	check('lastName')
		...
		.isLength({ min: 2, max: 15 })
		.withMessage('Please enter the last name between 2 to 15 characters'),
	...
	check('userName')
		...
		.isLength({ min: 2, max: 15 })
		.withMessage('Please enter the user name between 2 to 15 characters'),
...
// DELETE USER
export const deleteUserValidation = [check('password').trim().notEmpty().withMessage('Please enter your existing password')];
...
export const createProductValidation = [
	...
	check('productName')
		...
		.withMessage('Please enter namebetween 2 to 20 characters'),
